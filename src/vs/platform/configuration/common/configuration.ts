...
export interface IConfigurationValue<T> {
	...
	readonly workspaceLocal?: IInspectValue<T>;
	readonly workspaceFolder?: IInspectValue<T>;
	readonly workspaceFolderLocal?: IInspectValue<T>;
