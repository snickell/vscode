...
class ConfigurationInspectValue<V> implements IConfigurationValue<V> {
	...
	private _workspaceLocalInspectValue: IInspectValue<V> | undefined | null;
	private get workspaceLocalInspectValue(): IInspectValue<V> | null {
	...
	get workspaceLocal(): { value?: V; override?: V } | undefined {
		return this.workspaceLocalInspectValue?.value !== undefined || this.workspaceLocalInspectValue?.override !== undefined ? { value: this.workspaceLocalInspectValue.value, override: this.workspaceLocalInspectValue.override } : undefined;
	}
	...
	private _workspaceFolderLocalInspectValue: IInspectValue<V> | undefined | null;
	private get workspaceFolderLocalInspectValue(): IInspectValue<V> | null {
	...
	get workspaceFolderLocal(): { value?: V; override?: V } | undefined {
		return this.workspaceFolderLocalInspectValue?.value !== undefined || this.workspaceFolderLocalInspectValue?.override !== undefined ? { value: this.workspaceFolderLocalInspectValue.value, override: this.workspaceFolderLocalInspectValue.override } : undefined;
	}
...
export class Configuration {
	...
	constructor(
		...
		private _workspaceLocalConfiguration: ConfigurationModel = new ConfigurationModel(),
		private _folderLocalConfigurations: ResourceMap<ConfigurationModel> = new ResourceMap<ConfigurationModel>()
	) {
	}
	...
	static parse(data: IConfigurationData): Configuration {
		...
		const workspaceLocalConfiguration = this.parseConfigurationModel(data.workspaceLocal);
		...
		return new Configuration(defaultConfiguration, policyConfiguration, applicationConfiguration, userConfiguration, new ConfigurationModel(), workspaceConfiguration, folders, new ConfigurationModel(), new ResourceMap<ConfigurationModel>(), workspaceLocalConfiguration, foldersLocal);
	}

	private static parseConfigurationModel(model: IConfigurationModel | undefined): ConfigurationModel {
		return model ? new ConfigurationModel(model.contents, model.keys, model.overrides) : new ConfigurationModel();
	}
