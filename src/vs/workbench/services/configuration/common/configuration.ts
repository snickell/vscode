...
export const LOCAL_FOLDER_CONFIG_FOLDER_NAME = '.vscode.local';
export const FOLDER_SETTINGS_NAME = 'settings';
export const FOLDER_SETTINGS_PATH = `${FOLDER_CONFIG_FOLDER_NAME}/${FOLDER_SETTINGS_NAME}.json`;
export const LOCAL_FOLDER_SETTINGS_PATH = `${LOCAL_FOLDER_CONFIG_FOLDER_NAME}/${FOLDER_SETTINGS_NAME}.json`;
...
export const FOLDER_TASKS_PATH = `${FOLDER_CONFIG_FOLDER_NAME}/${TASKS_CONFIGURATION_KEY}.json`;
export const LOCAL_FOLDER_TASKS_PATH = `${LOCAL_FOLDER_CONFIG_FOLDER_NAME}/${TASKS_CONFIGURATION_KEY}.json`;
export const FOLDER_LAUNCH_PATH = `${FOLDER_CONFIG_FOLDER_NAME}/${LAUNCH_CONFIGURATION_KEY}.json`;
export const LOCAL_FOLDER_LAUNCH_PATH = `${LOCAL_FOLDER_CONFIG_FOLDER_NAME}/${LAUNCH_CONFIGURATION_KEY}.json`;
export const FOLDER_EXTENSIONS_PATH = `${FOLDER_CONFIG_FOLDER_NAME}/${EXTENSIONS_CONFIGURATION_KEY}.json`;
export const LOCAL_FOLDER_EXTENSIONS_PATH = `${LOCAL_FOLDER_CONFIG_FOLDER_NAME}/${EXTENSIONS_CONFIGURATION_KEY}.json`;

export const WORKSPACE_STANDALONE_CONFIGURATIONS = Object.create(null);
WORKSPACE_STANDALONE_CONFIGURATIONS[TASKS_CONFIGURATION_KEY] = FOLDER_TASKS_PATH;
WORKSPACE_STANDALONE_CONFIGURATIONS[LAUNCH_CONFIGURATION_KEY] = FOLDER_LAUNCH_PATH;
