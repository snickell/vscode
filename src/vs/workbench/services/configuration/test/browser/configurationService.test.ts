...
import { FOLDER_LOCAL_SETTINGS_PATH, FOLDER_LOCAL_STANDALONE_CONFIGURATIONS, getWorkspaceLocalConfigPath, IConfigurationCache } from 'vs/workbench/services/configuration/common/configuration';
