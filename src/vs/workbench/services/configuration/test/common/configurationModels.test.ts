...
import { LOCAL_WORKSPACE_FILE_CONFIGURATION_DESCRIPTORS, WORKSPACE_FILE_CONFIGURATION_DESCRIPTORS, WORKSPACE_STANDALONE_CONFIGURATION_DESCRIPTORS } from '../../common/workspaceFileConfiguration.js';
